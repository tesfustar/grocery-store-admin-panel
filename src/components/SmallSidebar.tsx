...
const SmallSidebar: React.FC<Props> = ({ isOpen, isSideBarOpen }) => {
  ...
  const activeLink =
    "flex items-center gap-5 pl-4 pt-3 rounded-md bg-main-bg text-white font-medium m-2 pb-2";
  const normalLink = `flex items-center gap-5 pl-4 pt-3 rounded-md text-gray-500  
  duration-700  hover:text-main-color  m-2  font-medium m-2 pb-2`;
