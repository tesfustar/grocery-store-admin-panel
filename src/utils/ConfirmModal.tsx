...
const ConfirmModal: React.FC<ConfirmModalProps> = ({ children }) => {
  const { confirmModalOpen, setConfirmModalOpen, isAmh } = useHome();
    ...
    <>
      <Transition appear show={confirmModalOpen} as={Fragment}>
        ...
        >
          ...
          <div className="fixed top-16 right-0 left-0 overflow-y-auto">
